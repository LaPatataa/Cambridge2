...
def Iniciar_Sesion():   
    ...
    driver.find_element(By.XPATH,value='//*[@id="gigya-loginID-56269462240752180"]').send_keys("umb-1013098477")
    driver.find_element(By.XPATH,value='//*[@id="gigya-password-56383998600152700"]').send_keys("umb-1013098477")
...
def Tarea_Escribir():
    ...
    if(Grammar == "Read about four movie classics. Write the number of the correct movie after each movie type."):
        correctas = ["2","1","4","3"]
    elif(Grammar == "Watch the video. In what order does Paul talk about the topics? Number the topics 1 to 7."):
        correctas = ["5","4","1","6","3","2","7"]
    elif(Grammar == "Put the words in order to make sentences with the same meaning."):
        correctas = ["don't mind answering","not good at making","can't stand making","like working with a"]
    elif(Grammar == "Watch the video. Number the steps from 1 to 6."):
        correctas = ["2","4","1","6","3","5"]
    else: 
...
def Tarea_desplegable():
    ...
    if Grammar1 == "1. Hank is doing":
        correctas = ["the chef is sick","a sports reporter","not very successful"]
...
def Tarea_DragAndDrop2():
    ...
    if(listen == "Listen to the conversation. Choose the correct place and activity for each person."):
        ...
        for i in range(len(inputs)):
            ...
            if cadena == "is there enough closet space in the bedroom?":
                cadena = "is there enough closet space in the bedrooms?"
            elif cadena == "in indonesia, balinese people observe a day of silence on nyepi day.":
                cadena = "in indonesia , balinese people observe a day of silence on nyepi day."
            print(cadena)
            print(opciones)
